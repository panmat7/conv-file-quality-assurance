...
public static class RtfPipelines
{
    ...
    private static void RtfToTextDocPipeline(FilePair pair, int additionalThreads, Action<int> updateThreadCount,
        Action markDone)
    {
        BasePipeline.ExecutePipeline(() =>
        {
            ...
            {
                var res = ComparingMethods.ComparingMethods.CheckFileSizeDifference(pair, 0.5); //Use settings later
